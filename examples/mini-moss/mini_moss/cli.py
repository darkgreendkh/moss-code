...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Moss agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-moss starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-moss" / "runs")
    return Moss(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-moss> ").strip()
